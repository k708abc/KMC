...
if __name__ == "__main__":
    ...
    chk_transformation = tk.Checkbutton(
        root, variable=bln_transformation, text="Transformation"
    )
    ...
    progress_bar = ttk.Progressbar(
        root, orient=tk.HORIZONTAL, length=350, mode="determinate"
    )
