...
def rec_ppt(params, minute, second, img_names, hist_names, time, coverage, dir_name):
    ...
    table.cell(0, 3).text = "Si(1-2)"
    table.cell(0, 4).text = "Si(2-3)"
    table.cell(0, 5).text = "Si(3-4)"
    table.cell(0, 6).text = "Si(4-5)"
    ...
    table.cell(1, 3).text = str(params.binding_energies["Si12"])
    table.cell(1, 4).text = str(params.binding_energies["Si23"])
    table.cell(1, 5).text = str(params.binding_energies["Si34"])
    table.cell(1, 6).text = str(params.binding_energies["Si45"])
