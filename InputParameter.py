...
class Params:
    ...
    def __init__(self) -> None:
        ...
        self.binding_energies["Si01"] = -0.2
        self.binding_energies["Si12"] = -0.2
        self.binding_energies["Si23"] = -0.2
        self.binding_energies["Si34"] = -0.25
        self.binding_energies["Si45"] = -0.25
        self.binding_energies["Si_inter"] = -0.25
        ...
        self.num_defect = 1
        self.record_name = "KMC_Si_rec_500"
        self.img_per = 20 / 3
        self.comments = "silicene 500 K"
