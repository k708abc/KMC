...
class Params:
    ...
    def __init__(self) -> None:
        ...
        self.binding_energies["Base"] = -0.9
        self.binding_energies["AgSi"] = -0.15
        self.binding_energies["Si12"] = -0.15
        self.binding_energies["Si23"] = -0.15
        self.binding_energies["Si34"] = -0.15
        self.binding_energies["Si45"] = -0.15
        self.binding_energies["Si56"] = -0.15
