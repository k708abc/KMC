...
class Params:
    ...
    def __init__(self) -> None:
        ...
        self.binding_energies["AgSi"] = -0.15
        self.binding_energies["Si12"] = -0.12
        self.binding_energies["Si23"] = -0.12
        self.binding_energies["Si34"] = -0.12
        self.binding_energies["Si45"] = -0.12
        self.binding_energies["Si56"] = -0.12
        self.binding_energies["Si_intra"] = -0.15
        self.binding_energies["Si_inter"] = -0.15
