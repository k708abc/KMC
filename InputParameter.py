...
class Params:
    ...
    def __init__(self) -> None:
        ...
        # self.binding_energies["Ag base"] = -0.8
        # self.binding_energies["AgSi"] = -0.3
        # self.binding_energies["Si base"] = -1
        ...
        # self.binding_energies["Si_4"] = -0.2
        # self.binding_energies["Si_5"] = -0.2
        ...
        # self.diffusion_barriers["Si_4"] = -1.4
        # self.diffusion_barriers["Si_5"] = -1.4
        # self.diffusion_barriers["Si_even"] = -1.4
        # self.diffusion_barriers["Si_odd"] = -1.4
        #
