...
{
    "distutils": {
        "name": "Rejection_free_kmc",
        "sources": [
            "Rejection_free_kmc.pyx"
        ]
    },
    "module_name": "Rejection_free_kmc"
}
END: Cython Metadata */
...
#define __PYX_HAVE__Rejection_free_kmc
#define __PYX_HAVE_API__Rejection_free_kmc
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/*--- Type declarations ---*/
struct __pyx_obj_18Rejection_free_kmc_Params;
struct __pyx_obj_18Rejection_free_kmc_common_functions;
struct __pyx_obj_18Rejection_free_kmc_rejection_free;

/* "Rejection_free_kmc.pyx":22
 * 
 * 
 * cdef class Params:             # <<<<<<<<<<<<<<
...
struct __pyx_obj_18Rejection_free_kmc_Params {
  ...
  double distance_intra;
  double img_per;
  double prefactor;
  double repeat_E1_diff;
  double repeat_E1_end;
  double repeat_E1_start;
  double repeat_E2_diff;
  double repeat_E2_end;
  double repeat_E2_start;
  double temperature;
  PyObject *energies_binding;
  PyObject *energies_diffusion;
  int first_put_check;
  int start_from_middle;
  int trans_check;
  char comments;
  char record_name;
};
...
struct __pyx_obj_18Rejection_free_kmc_common_functions {
  PyObject_HEAD
  struct __pyx_vtabstruct_18Rejection_free_kmc_common_functions *__pyx_vtab;
  double start_time;
  ...
  PyObject *move_atom;
  PyObject *target;
  struct __pyx_obj_18Rejection_free_kmc_Params *init_value;
};
 ...
 */
struct __pyx_obj_18Rejection_free_kmc_rejection_free {
  struct __pyx_obj_18Rejection_free_kmc_common_functions __pyx_base;
};
...
struct __pyx_vtabstruct_18Rejection_free_kmc_common_functions {
  PyObject *(*start_setting)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*update_progress)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*start_rejection_free)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*energy_summarize)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*height_check_add)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, PyObject *, int __pyx_skip_dispatch);
  int (*height_check_remove)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, PyObject *, int __pyx_skip_dispatch);
  PyObject *(*deposition)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*update_after_deposition)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, PyObject *, int __pyx_skip_dispatch);
  PyObject *(*update_events)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*recalculate_total_rate)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  double (*compare_rate)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*rejection_free_deposition)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*put_first_atoms_rf)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*rejection_free_event)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*event_progress)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*pickle_dump)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, PyObject *, PyObject *, int __pyx_skip_dispatch);
  PyObject *(*parameter_record)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*rejection_free_loop)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*record_position)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
  PyObject *(*end_of_loop)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch);
};
...
struct __pyx_vtabstruct_18Rejection_free_kmc_rejection_free {
  struct __pyx_vtabstruct_18Rejection_free_kmc_common_functions __pyx_base;
  PyObject *(*loop)(struct __pyx_obj_18Rejection_free_kmc_rejection_free *, int __pyx_skip_dispatch);
  PyObject *(*end)(struct __pyx_obj_18Rejection_free_kmc_rejection_free *, int __pyx_skip_dispatch);
  PyObject *(*start)(struct __pyx_obj_18Rejection_free_kmc_rejection_free *, int __pyx_skip_dispatch);
  PyObject *(*start_from_middle)(struct __pyx_obj_18Rejection_free_kmc_rejection_free *, int __pyx_skip_dispatch);
};
static struct __pyx_vtabstruct_18Rejection_free_kmc_rejection_free *__pyx_vtabptr_18Rejection_free_kmc_rejection_free;
...
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_start_setting(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_update_progress(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_start_rejection_free(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_energy_summarize(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_height_check_add(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_pos, int __pyx_skip_dispatch); /* proto*/
static int __pyx_f_18Rejection_free_kmc_16common_functions_height_check_remove(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_pos, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_deposition(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_update_after_deposition(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_dep_pos, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_update_events(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_recalculate_total_rate(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static double __pyx_f_18Rejection_free_kmc_16common_functions_compare_rate(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_rejection_free_deposition(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_put_first_atoms_rf(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_rejection_free_event(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_event_progress(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_pickle_dump(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_obj, PyObject *__pyx_v_path, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_parameter_record(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_rejection_free_loop(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_record_position(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_end_of_loop(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_14rejection_free_loop(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_14rejection_free_end(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_14rejection_free_start(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_14rejection_free_start_from_middle(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self, int __pyx_skip_dispatch); /* proto*/

/* Module declarations from 'Rejection_free_kmc' */
static PyTypeObject *__pyx_ptype_18Rejection_free_kmc_Params = 0;
static PyTypeObject *__pyx_ptype_18Rejection_free_kmc_common_functions = 0;
static PyTypeObject *__pyx_ptype_18Rejection_free_kmc_rejection_free = 0;
#define __Pyx_MODULE_NAME "Rejection_free_kmc"
extern int __pyx_module_is_main_Rejection_free_kmc;
int __pyx_module_is_main_Rejection_free_kmc = 0;

/* Implementation of 'Rejection_free_kmc' */
...
static const char __pyx_k_rf_class[] = "rf_class";
...
static const char __pyx_k_Loop_start[] = "Loop start";
static const char __pyx_k_Time_event[] = "Time/event: ";
...
static const char __pyx_k_rejection_free[] = "rejection_free";
...
static const char __pyx_k_current_number_of_atoms[] = "current number of atoms";
...
static PyObject *__pyx_kp_s_Calculation_start;
static PyObject *__pyx_kp_s_Finished;
static PyObject *__pyx_kp_s_Loop_start;
...
static PyObject *__pyx_kp_s_Time_event;
...
static PyObject *__pyx_kp_s_current_number_of_atoms;
...
static PyObject *__pyx_n_s_rejection_free;
...
static PyObject *__pyx_n_s_rf_class;
...
static int __pyx_pf_18Rejection_free_kmc_6Params___cinit__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self, PyObject *__pyx_v_filename); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_14temperature_eV___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_11atoms_in_BL___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_21dep_rate_atoms_persec___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_10total_time___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_8interval___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_11total_atoms___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_21rec_num_atom_interval___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_2__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_4__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state); /* proto */
static int __pyx_pf_18Rejection_free_kmc_16common_functions___cinit__(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_2start_setting(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_4update_progress(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_6start_rejection_free(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_8energy_summarize(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_10height_check_add(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_pos); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_12height_check_remove(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_pos); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_14deposition(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_16update_after_deposition(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_dep_pos); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_18update_events(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_20recalculate_total_rate(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_22compare_rate(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_24rejection_free_deposition(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_26put_first_atoms_rf(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_28rejection_free_event(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_30event_progress(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_32pickle_dump(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_obj, PyObject *__pyx_v_path); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_34parameter_record(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_36rejection_free_loop(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_38record_position(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_40end_of_loop(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_42__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_44__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state); /* proto */
static int __pyx_pf_18Rejection_free_kmc_14rejection_free___cinit__(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self, int __pyx_v_setting_value); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_14rejection_free_2loop(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_14rejection_free_4end(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_14rejection_free_6start(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_14rejection_free_8start_from_middle(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_14rejection_free_10__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_18Rejection_free_kmc_14rejection_free_12__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state); /* proto */
static PyObject *__pyx_tp_new_18Rejection_free_kmc_Params(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
static PyObject *__pyx_tp_new_18Rejection_free_kmc_common_functions(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
static PyObject *__pyx_tp_new_18Rejection_free_kmc_rejection_free(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
/* Python wrapper */
static int __pyx_pw_18Rejection_free_kmc_6Params_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_18Rejection_free_kmc_6Params_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_18Rejection_free_kmc_6Params___cinit__(((struct __pyx_obj_18Rejection_free_kmc_Params *)__pyx_v_self), __pyx_v_filename);
...
static int __pyx_pf_18Rejection_free_kmc_6Params___cinit__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self, PyObject *__pyx_v_filename) {
  PyObject *__pyx_v_f = NULL;
  PyObject *__pyx_v_input_yaml = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_v_input_yaml);
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_14temperature_eV_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_14temperature_eV_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_6Params_14temperature_eV___get__(((struct __pyx_obj_18Rejection_free_kmc_Params *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_14temperature_eV___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self) {
 ...
 */
  ...
  __Pyx_AddTraceback("Rejection_free_kmc.Params.temperature_eV.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_11atoms_in_BL_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_11atoms_in_BL_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_6Params_11atoms_in_BL___get__(((struct __pyx_obj_18Rejection_free_kmc_Params *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_11atoms_in_BL___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_AddTraceback("Rejection_free_kmc.Params.atoms_in_BL.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_21dep_rate_atoms_persec_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_21dep_rate_atoms_persec_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_6Params_21dep_rate_atoms_persec___get__(((struct __pyx_obj_18Rejection_free_kmc_Params *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_21dep_rate_atoms_persec___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_AddTraceback("Rejection_free_kmc.Params.dep_rate_atoms_persec.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_10total_time_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_10total_time_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_6Params_10total_time___get__(((struct __pyx_obj_18Rejection_free_kmc_Params *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_10total_time___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("Rejection_free_kmc.Params.total_time.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_8interval_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_8interval_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_6Params_8interval___get__(((struct __pyx_obj_18Rejection_free_kmc_Params *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_8interval___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_AddTraceback("Rejection_free_kmc.Params.interval.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_11total_atoms_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_11total_atoms_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_6Params_11total_atoms___get__(((struct __pyx_obj_18Rejection_free_kmc_Params *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_11total_atoms___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_AddTraceback("Rejection_free_kmc.Params.total_atoms.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_21rec_num_atom_interval_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_21rec_num_atom_interval_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_6Params_21rec_num_atom_interval___get__(((struct __pyx_obj_18Rejection_free_kmc_Params *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_21rec_num_atom_interval___get__(struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_AddTraceback("Rejection_free_kmc.Params.rec_num_atom_interval.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_3__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_3__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__reduce_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_6Params_2__reduce_cython__(((struct __pyx_obj_18Rejection_free_kmc_Params *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_2__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("Rejection_free_kmc.Params.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_5__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_6Params_5__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__setstate_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_6Params_4__setstate_cython__(((struct __pyx_obj_18Rejection_free_kmc_Params *)__pyx_v_self), ((PyObject *)__pyx_v___pyx_state));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_6Params_4__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_Params *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("Rejection_free_kmc.Params.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static int __pyx_pw_18Rejection_free_kmc_16common_functions_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_18Rejection_free_kmc_16common_functions_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  ...
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions___cinit__(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static int __pyx_pf_18Rejection_free_kmc_16common_functions___cinit__(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __Pyx_DECREF(((PyObject *)__pyx_v_self->init_value));
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.__cinit__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_3start_setting(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_start_setting(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.start_setting", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_3start_setting(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_3start_setting(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("start_setting (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_2start_setting(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_2start_setting(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_5update_progress(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_update_progress(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.update_progress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_5update_progress(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_5update_progress(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("update_progress (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_4update_progress(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_4update_progress(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_7start_rejection_free(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_start_rejection_free(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.start_rejection_free", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_7start_rejection_free(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_7start_rejection_free(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("start_rejection_free (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_6start_rejection_free(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_6start_rejection_free(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_9energy_summarize(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_energy_summarize(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
 ...
 *         #
 */
  __pyx_t_10 = ((__pyx_v_self->init_value->cell_size_z * 6) - 2);
 ...
 * 
 */
  __pyx_t_4 = __pyx_v_self->energy_diffuse;
  __Pyx_INCREF(__pyx_t_4);
 ...
 */
  ...
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.energy_summarize", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_9energy_summarize(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_9energy_summarize(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("energy_summarize (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_8energy_summarize(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_8energy_summarize(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_11height_check_add(PyObject *__pyx_v_self, PyObject *__pyx_v_pos); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_height_check_add(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_pos, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_XDECREF(__pyx_t_6);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.height_check_add", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_11height_check_add(PyObject *__pyx_v_self, PyObject *__pyx_v_pos); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_11height_check_add(PyObject *__pyx_v_self, PyObject *__pyx_v_pos) {
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_10height_check_add(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_pos) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_13height_check_remove(PyObject *__pyx_v_self, PyObject *__pyx_v_pos); /*proto*/
static int __pyx_f_18Rejection_free_kmc_16common_functions_height_check_remove(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_pos, int __pyx_skip_dispatch) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_XDECREF(__pyx_t_6);
  __Pyx_WriteUnraisable("Rejection_free_kmc.common_functions.height_check_remove", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_13height_check_remove(PyObject *__pyx_v_self, PyObject *__pyx_v_pos); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_13height_check_remove(PyObject *__pyx_v_self, PyObject *__pyx_v_pos) {
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_12height_check_remove(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_pos) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.height_check_remove", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_15deposition(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_deposition(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.deposition", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_15deposition(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_15deposition(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("deposition (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_14deposition(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_14deposition(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_17update_after_deposition(PyObject *__pyx_v_self, PyObject *__pyx_v_dep_pos); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_update_after_deposition(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_dep_pos, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.update_after_deposition", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_17update_after_deposition(PyObject *__pyx_v_self, PyObject *__pyx_v_dep_pos); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_17update_after_deposition(PyObject *__pyx_v_self, PyObject *__pyx_v_dep_pos) {
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_16update_after_deposition(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_dep_pos) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_19update_events(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_update_events(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
 ...
 */
      ...
      #endif
      {
        ...
        __Pyx_INCREF(__pyx_v_self->atom_set);
        __Pyx_GIVEREF(__pyx_v_self->atom_set);
        PyTuple_SET_ITEM(__pyx_t_8, 0+__pyx_t_7, __pyx_v_self->atom_set);
        __Pyx_INCREF(__pyx_v_self->bonds);
        __Pyx_GIVEREF(__pyx_v_self->bonds);
        PyTuple_SET_ITEM(__pyx_t_8, 1+__pyx_t_7, __pyx_v_self->bonds);
        __Pyx_INCREF(__pyx_v_target_rel);
        __Pyx_GIVEREF(__pyx_v_target_rel);
        PyTuple_SET_ITEM(__pyx_t_8, 2+__pyx_t_7, __pyx_v_target_rel);
        __Pyx_INCREF(((PyObject *)__pyx_v_self->init_value));
        __Pyx_GIVEREF(((PyObject *)__pyx_v_self->init_value));
        PyTuple_SET_ITEM(__pyx_t_8, 3+__pyx_t_7, ((PyObject *)__pyx_v_self->init_value));
        __Pyx_INCREF(__pyx_v_self->energy_bonding);
        __Pyx_GIVEREF(__pyx_v_self->energy_bonding);
        PyTuple_SET_ITEM(__pyx_t_8, 4+__pyx_t_7, __pyx_v_self->energy_bonding);
        __Pyx_INCREF(__pyx_v_self->energy_diffuse);
        __Pyx_GIVEREF(__pyx_v_self->energy_diffuse);
        PyTuple_SET_ITEM(__pyx_t_8, 5+__pyx_t_7, __pyx_v_self->energy_diffuse);
        __Pyx_INCREF(__pyx_v_self->diffuse_candidates);
        __Pyx_GIVEREF(__pyx_v_self->diffuse_candidates);
        PyTuple_SET_ITEM(__pyx_t_8, 6+__pyx_t_7, __pyx_v_self->diffuse_candidates);
        __Pyx_INCREF(__pyx_v_self->highest_atom);
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_XDECREF(__pyx_t_8);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.update_events", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_19update_events(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_19update_events(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("update_events (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_18update_events(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_18update_events(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_21recalculate_total_rate(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_recalculate_total_rate(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
  double __pyx_v_rate;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.recalculate_total_rate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_21recalculate_total_rate(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_21recalculate_total_rate(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("recalculate_total_rate (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_20recalculate_total_rate(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_20recalculate_total_rate(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_23compare_rate(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static double __pyx_f_18Rejection_free_kmc_16common_functions_compare_rate(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_WriteUnraisable("Rejection_free_kmc.common_functions.compare_rate", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_23compare_rate(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_23compare_rate(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("compare_rate (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_22compare_rate(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_22compare_rate(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.compare_rate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_25rejection_free_deposition(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_rejection_free_deposition(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
  PyObject *__pyx_v_dep_pos = 0;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_6);
  __Pyx_XDECREF(__pyx_t_8);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.rejection_free_deposition", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_dep_pos);
  __Pyx_XGIVEREF(__pyx_r);
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_25rejection_free_deposition(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_25rejection_free_deposition(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("rejection_free_deposition (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_24rejection_free_deposition(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_24rejection_free_deposition(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_27put_first_atoms_rf(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_put_first_atoms_rf(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
  CYTHON_UNUSED int __pyx_v__;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
 ...
 * 
 */
    __pyx_t_6 = ((long)__pyx_v_self->init_value->first_put_num);
    __pyx_t_7 = __pyx_t_6;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.put_first_atoms_rf", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_27put_first_atoms_rf(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_27put_first_atoms_rf(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("put_first_atoms_rf (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_26put_first_atoms_rf(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_26put_first_atoms_rf(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_29rejection_free_event(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_rejection_free_event(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  #endif
  {
    ...
    PyTuple_SET_ITEM(__pyx_t_5, 0+__pyx_t_6, __pyx_v_self->move_atom);
    __Pyx_INCREF(__pyx_v_self->atom_set);
    __Pyx_GIVEREF(__pyx_v_self->atom_set);
    PyTuple_SET_ITEM(__pyx_t_5, 1+__pyx_t_6, __pyx_v_self->atom_set);
    __Pyx_INCREF(__pyx_v_self->bonds);
    __Pyx_GIVEREF(__pyx_v_self->bonds);
    PyTuple_SET_ITEM(__pyx_t_5, 2+__pyx_t_6, __pyx_v_self->bonds);
    __Pyx_INCREF(__pyx_v_self->diffuse_candidates);
    __Pyx_GIVEREF(__pyx_v_self->diffuse_candidates);
    PyTuple_SET_ITEM(__pyx_t_5, 3+__pyx_t_6, __pyx_v_self->diffuse_candidates);
    __Pyx_GIVEREF(__pyx_t_7);
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_5);
  __Pyx_XDECREF(__pyx_t_7);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.rejection_free_event", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_29rejection_free_event(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_29rejection_free_event(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("rejection_free_event (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_28rejection_free_event(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_28rejection_free_event(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_31event_progress(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_event_progress(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.event_progress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_31event_progress(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_31event_progress(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("event_progress (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_30event_progress(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_30event_progress(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_33pickle_dump(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_pickle_dump(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_obj, PyObject *__pyx_v_path, int __pyx_skip_dispatch) {
  PyObject *__pyx_v_f = NULL;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_33pickle_dump(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_33pickle_dump(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_32pickle_dump(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self), __pyx_v_obj, __pyx_v_path);
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_32pickle_dump(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, PyObject *__pyx_v_obj, PyObject *__pyx_v_path) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_35parameter_record(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_parameter_record(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.parameter_record", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_35parameter_record(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_35parameter_record(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("parameter_record (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_34parameter_record(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_34parameter_record(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_37rejection_free_loop(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_rejection_free_loop(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_6);
  __Pyx_XDECREF(__pyx_t_8);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.rejection_free_loop", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_37rejection_free_loop(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_37rejection_free_loop(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("rejection_free_loop (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_36rejection_free_loop(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_36rejection_free_loop(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_39record_position(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_record_position(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.record_position", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_39record_position(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_39record_position(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("record_position (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_38record_position(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_38record_position(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_41end_of_loop(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_16common_functions_end_of_loop(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, int __pyx_skip_dispatch) {
 ...
 */
  ...
  #endif
  {
    ...
    PyTuple_SET_ITEM(__pyx_t_4, 0+__pyx_t_6, __pyx_v_self->n_events_rec);
    __Pyx_INCREF(__pyx_v_self->num_atoms_rec);
    __Pyx_GIVEREF(__pyx_v_self->num_atoms_rec);
    PyTuple_SET_ITEM(__pyx_t_4, 1+__pyx_t_6, __pyx_v_self->num_atoms_rec);
    __Pyx_INCREF(((PyObject *)__pyx_v_self->init_value));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_self->init_value));
 ...
 */
  ...
  #endif
  {
    ...
    PyTuple_SET_ITEM(__pyx_t_9, 0+__pyx_t_6, __pyx_v_self->pos_rec);
    __Pyx_INCREF(__pyx_v_self->time_rec);
    __Pyx_GIVEREF(__pyx_v_self->time_rec);
    PyTuple_SET_ITEM(__pyx_t_9, 1+__pyx_t_6, __pyx_v_self->time_rec);
    __Pyx_INCREF(__pyx_v_self->cov_rec);
    __Pyx_GIVEREF(__pyx_v_self->cov_rec);
    PyTuple_SET_ITEM(__pyx_t_9, 2+__pyx_t_6, __pyx_v_self->cov_rec);
    __Pyx_INCREF(__pyx_v_self->lattice);
    __Pyx_GIVEREF(__pyx_v_self->lattice);
    PyTuple_SET_ITEM(__pyx_t_9, 3+__pyx_t_6, __pyx_v_self->lattice);
    __Pyx_INCREF(((PyObject *)__pyx_v_self->init_value));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_self->init_value));
    PyTuple_SET_ITEM(__pyx_t_9, 4+__pyx_t_6, ((PyObject *)__pyx_v_self->init_value));
    __Pyx_GIVEREF(__pyx_t_4);
    PyTuple_SET_ITEM(__pyx_t_9, 5+__pyx_t_6, __pyx_t_4);
    __Pyx_GIVEREF(__pyx_t_3);
    PyTuple_SET_ITEM(__pyx_t_9, 6+__pyx_t_6, __pyx_t_3);
    __Pyx_GIVEREF(__pyx_t_7);
    PyTuple_SET_ITEM(__pyx_t_9, 7+__pyx_t_6, __pyx_t_7);
    __Pyx_INCREF(((PyObject *)__pyx_v_self->init_value));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_self->init_value));
    PyTuple_SET_ITEM(__pyx_t_9, 8+__pyx_t_6, ((PyObject *)__pyx_v_self->init_value));
    __pyx_t_4 = 0;
    __pyx_t_3 = 0;
    __pyx_t_7 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_8);
  __Pyx_XDECREF(__pyx_t_9);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.end_of_loop", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_41end_of_loop(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_41end_of_loop(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("end_of_loop (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_40end_of_loop(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_40end_of_loop(struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_43__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_43__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__reduce_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_42__reduce_cython__(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_42__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_45__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_16common_functions_45__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__setstate_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_16common_functions_44__setstate_cython__(((struct __pyx_obj_18Rejection_free_kmc_common_functions *)__pyx_v_self), ((PyObject *)__pyx_v___pyx_state));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_16common_functions_44__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_common_functions *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("Rejection_free_kmc.common_functions.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static int __pyx_pw_18Rejection_free_kmc_14rejection_free_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_18Rejection_free_kmc_14rejection_free_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_setting_value;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  int __pyx_r;
  ...
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_setting_value,0};
    PyObject* values[1] = {0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_setting_value)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
      }
      if (unlikely(kw_args > 0)) {
  ...
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_18Rejection_free_kmc_14rejection_free___cinit__(((struct __pyx_obj_18Rejection_free_kmc_rejection_free *)__pyx_v_self), __pyx_v_setting_value);
...
static int __pyx_pf_18Rejection_free_kmc_14rejection_free___cinit__(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self, int __pyx_v_setting_value) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_3loop(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_14rejection_free_loop(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.rejection_free.loop", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_3loop(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_3loop(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("loop (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_14rejection_free_2loop(((struct __pyx_obj_18Rejection_free_kmc_rejection_free *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_14rejection_free_2loop(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_5end(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_14rejection_free_end(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 *         self.end_of_loop()
 */
  switch (__pyx_v_self->__pyx_base.setting_value) {
    case 1:
    case 0:
 ...
 * 
 */
  __pyx_t_5 = ((__pyx_v_self->__pyx_base.setting_value == 0) != 0);
  if (__pyx_t_5) {
  }
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.rejection_free.end", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_5end(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_5end(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("end (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_14rejection_free_4end(((struct __pyx_obj_18Rejection_free_kmc_rejection_free *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_14rejection_free_4end(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_7start(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_14rejection_free_start(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.rejection_free.start", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_7start(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_7start(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("start (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_14rejection_free_6start(((struct __pyx_obj_18Rejection_free_kmc_rejection_free *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_14rejection_free_6start(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_9start_from_middle(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_18Rejection_free_kmc_14rejection_free_start_from_middle(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self, int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("Rejection_free_kmc.rejection_free.start_from_middle", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_9start_from_middle(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_9start_from_middle(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("start_from_middle (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_14rejection_free_8start_from_middle(((struct __pyx_obj_18Rejection_free_kmc_rejection_free *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_14rejection_free_8start_from_middle(struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_11__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_11__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__reduce_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_14rejection_free_10__reduce_cython__(((struct __pyx_obj_18Rejection_free_kmc_rejection_free *)__pyx_v_self));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_14rejection_free_10__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("Rejection_free_kmc.rejection_free.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_13__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state); /*proto*/
static PyObject *__pyx_pw_18Rejection_free_kmc_14rejection_free_13__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__setstate_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_18Rejection_free_kmc_14rejection_free_12__setstate_cython__(((struct __pyx_obj_18Rejection_free_kmc_rejection_free *)__pyx_v_self), ((PyObject *)__pyx_v___pyx_state));
...
static PyObject *__pyx_pf_18Rejection_free_kmc_14rejection_free_12__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_18Rejection_free_kmc_rejection_free *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("Rejection_free_kmc.rejection_free.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyObject *__pyx_tp_new_18Rejection_free_kmc_Params(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_18Rejection_free_kmc_Params *p;
  PyObject *o;
  ...
  p = ((struct __pyx_obj_18Rejection_free_kmc_Params *)o);
  p->energies_binding = ((PyObject*)Py_None); Py_INCREF(Py_None);
  p->energies_diffusion = ((PyObject*)Py_None); Py_INCREF(Py_None);
  if (unlikely(__pyx_pw_18Rejection_free_kmc_6Params_1__cinit__(o, a, k) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
static void __pyx_tp_dealloc_18Rejection_free_kmc_Params(PyObject *o) {
  struct __pyx_obj_18Rejection_free_kmc_Params *p = (struct __pyx_obj_18Rejection_free_kmc_Params *)o;
  ...
  Py_CLEAR(p->energies_binding);
  Py_CLEAR(p->energies_diffusion);
  (*Py_TYPE(o)->tp_free)(o);
}

static int __pyx_tp_traverse_18Rejection_free_kmc_Params(PyObject *o, visitproc v, void *a) {
  int e;
  struct __pyx_obj_18Rejection_free_kmc_Params *p = (struct __pyx_obj_18Rejection_free_kmc_Params *)o;
  if (p->energies_binding) {
    e = (*v)(p->energies_binding, a); if (e) return e;
  }
  if (p->energies_diffusion) {
    e = (*v)(p->energies_diffusion, a); if (e) return e;
  }
  return 0;
}

static int __pyx_tp_clear_18Rejection_free_kmc_Params(PyObject *o) {
  PyObject* tmp;
  struct __pyx_obj_18Rejection_free_kmc_Params *p = (struct __pyx_obj_18Rejection_free_kmc_Params *)o;
  tmp = ((PyObject*)p->energies_binding);
  p->energies_binding = ((PyObject*)Py_None); Py_INCREF(Py_None);
  Py_XDECREF(tmp);
  tmp = ((PyObject*)p->energies_diffusion);
  p->energies_diffusion = ((PyObject*)Py_None); Py_INCREF(Py_None);
  Py_XDECREF(tmp);
  return 0;
}

static PyObject *__pyx_getprop_18Rejection_free_kmc_6Params_temperature_eV(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_18Rejection_free_kmc_6Params_14temperature_eV_1__get__(o);
}

static PyObject *__pyx_getprop_18Rejection_free_kmc_6Params_atoms_in_BL(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_18Rejection_free_kmc_6Params_11atoms_in_BL_1__get__(o);
}

static PyObject *__pyx_getprop_18Rejection_free_kmc_6Params_dep_rate_atoms_persec(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_18Rejection_free_kmc_6Params_21dep_rate_atoms_persec_1__get__(o);
}

static PyObject *__pyx_getprop_18Rejection_free_kmc_6Params_total_time(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_18Rejection_free_kmc_6Params_10total_time_1__get__(o);
}

static PyObject *__pyx_getprop_18Rejection_free_kmc_6Params_interval(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_18Rejection_free_kmc_6Params_8interval_1__get__(o);
}

static PyObject *__pyx_getprop_18Rejection_free_kmc_6Params_total_atoms(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_18Rejection_free_kmc_6Params_11total_atoms_1__get__(o);
}

static PyObject *__pyx_getprop_18Rejection_free_kmc_6Params_rec_num_atom_interval(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_18Rejection_free_kmc_6Params_21rec_num_atom_interval_1__get__(o);
}

static PyMethodDef __pyx_methods_18Rejection_free_kmc_Params[] = {
  {"__reduce_cython__", (PyCFunction)__pyx_pw_18Rejection_free_kmc_6Params_3__reduce_cython__, METH_NOARGS, 0},
  {"__setstate_cython__", (PyCFunction)__pyx_pw_18Rejection_free_kmc_6Params_5__setstate_cython__, METH_O, 0},
  {0, 0, 0, 0}
};

static struct PyGetSetDef __pyx_getsets_18Rejection_free_kmc_Params[] = {
  {(char *)"temperature_eV", __pyx_getprop_18Rejection_free_kmc_6Params_temperature_eV, 0, (char *)0, 0},
  {(char *)"atoms_in_BL", __pyx_getprop_18Rejection_free_kmc_6Params_atoms_in_BL, 0, (char *)0, 0},
  {(char *)"dep_rate_atoms_persec", __pyx_getprop_18Rejection_free_kmc_6Params_dep_rate_atoms_persec, 0, (char *)0, 0},
  {(char *)"total_time", __pyx_getprop_18Rejection_free_kmc_6Params_total_time, 0, (char *)0, 0},
  {(char *)"interval", __pyx_getprop_18Rejection_free_kmc_6Params_interval, 0, (char *)0, 0},
  {(char *)"total_atoms", __pyx_getprop_18Rejection_free_kmc_6Params_total_atoms, 0, (char *)0, 0},
  {(char *)"rec_num_atom_interval", __pyx_getprop_18Rejection_free_kmc_6Params_rec_num_atom_interval, 0, (char *)0, 0},
  {0, 0, 0, 0, 0}
};

static PyTypeObject __pyx_type_18Rejection_free_kmc_Params = {
  PyVarObject_HEAD_INIT(0, 0)
  "Rejection_free_kmc.Params", /*tp_name*/
  sizeof(struct __pyx_obj_18Rejection_free_kmc_Params), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_18Rejection_free_kmc_Params, /*tp_dealloc*/
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_18Rejection_free_kmc_Params, /*tp_traverse*/
  __pyx_tp_clear_18Rejection_free_kmc_Params, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_18Rejection_free_kmc_Params, /*tp_methods*/
  0, /*tp_members*/
  __pyx_getsets_18Rejection_free_kmc_Params, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  0, /*tp_descr_get*/
  0, /*tp_descr_set*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_18Rejection_free_kmc_Params, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static struct __pyx_vtabstruct_18Rejection_free_kmc_common_functions __pyx_vtable_18Rejection_free_kmc_common_functions;

static PyObject *__pyx_tp_new_18Rejection_free_kmc_common_functions(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  struct __pyx_obj_18Rejection_free_kmc_common_functions *p;
  PyObject *o;
  if (likely((t->tp_flags & Py_TPFLAGS_IS_ABSTRACT) == 0)) {
    o = (*t->tp_alloc)(t, 0);
  } else {
  ...
  if (unlikely(!o)) return 0;
  p = ((struct __pyx_obj_18Rejection_free_kmc_common_functions *)o);
  p->__pyx_vtab = __pyx_vtabptr_18Rejection_free_kmc_common_functions;
  ...
  p->init_value = ((struct __pyx_obj_18Rejection_free_kmc_Params *)Py_None); Py_INCREF(Py_None);
  if (unlikely(__pyx_pw_18Rejection_free_kmc_16common_functions_1__cinit__(o, __pyx_empty_tuple, NULL) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
static void __pyx_tp_dealloc_18Rejection_free_kmc_common_functions(PyObject *o) {
  struct __pyx_obj_18Rejection_free_kmc_common_functions *p = (struct __pyx_obj_18Rejection_free_kmc_common_functions *)o;
  #if CYTHON_USE_TP_FINALIZE
  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && !_PyGC_FINALIZED(o)) {
    if (PyObject_CallFinalizerFromDealloc(o)) return;
  }
...
static int __pyx_tp_traverse_18Rejection_free_kmc_common_functions(PyObject *o, visitproc v, void *a) {
  int e;
  struct __pyx_obj_18Rejection_free_kmc_common_functions *p = (struct __pyx_obj_18Rejection_free_kmc_common_functions *)o;
  if (p->pos_rec) {
  ...
  if (p->init_value) {
    e = (*v)(((PyObject *)p->init_value), a); if (e) return e;
  }
  return 0;
}

static int __pyx_tp_clear_18Rejection_free_kmc_common_functions(PyObject *o) {
  PyObject* tmp;
  struct __pyx_obj_18Rejection_free_kmc_common_functions *p = (struct __pyx_obj_18Rejection_free_kmc_common_functions *)o;
...
static PyMethodDef __pyx_methods_18Rejection_free_kmc_common_functions[] = {
  {"start_setting", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_3start_setting, METH_NOARGS, 0},
  {"update_progress", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_5update_progress, METH_NOARGS, 0},
  {"start_rejection_free", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_7start_rejection_free, METH_NOARGS, 0},
  {"energy_summarize", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_9energy_summarize, METH_NOARGS, 0},
  {"height_check_add", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_11height_check_add, METH_O, 0},
  {"height_check_remove", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_13height_check_remove, METH_O, 0},
  {"deposition", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_15deposition, METH_NOARGS, 0},
  {"update_after_deposition", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_17update_after_deposition, METH_O, 0},
  {"update_events", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_19update_events, METH_NOARGS, 0},
  {"recalculate_total_rate", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_21recalculate_total_rate, METH_NOARGS, 0},
  {"compare_rate", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_23compare_rate, METH_NOARGS, 0},
  {"rejection_free_deposition", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_25rejection_free_deposition, METH_NOARGS, 0},
  {"put_first_atoms_rf", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_27put_first_atoms_rf, METH_NOARGS, 0},
  {"rejection_free_event", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_29rejection_free_event, METH_NOARGS, 0},
  {"event_progress", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_31event_progress, METH_NOARGS, 0},
  {"pickle_dump", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_18Rejection_free_kmc_16common_functions_33pickle_dump, METH_VARARGS|METH_KEYWORDS, 0},
  {"parameter_record", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_35parameter_record, METH_NOARGS, 0},
  {"rejection_free_loop", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_37rejection_free_loop, METH_NOARGS, 0},
  {"record_position", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_39record_position, METH_NOARGS, 0},
  {"end_of_loop", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_41end_of_loop, METH_NOARGS, 0},
  {"__reduce_cython__", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_43__reduce_cython__, METH_NOARGS, 0},
  {"__setstate_cython__", (PyCFunction)__pyx_pw_18Rejection_free_kmc_16common_functions_45__setstate_cython__, METH_O, 0},
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_18Rejection_free_kmc_common_functions = {
  PyVarObject_HEAD_INIT(0, 0)
  "Rejection_free_kmc.common_functions", /*tp_name*/
  sizeof(struct __pyx_obj_18Rejection_free_kmc_common_functions), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_18Rejection_free_kmc_common_functions, /*tp_dealloc*/
  #if PY_VERSION_HEX < 0x030800b4
  0, /*tp_print*/
  #endif
  #if PY_VERSION_HEX >= 0x030800b4
  ...
  Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_VERSION_TAG|Py_TPFLAGS_CHECKTYPES|Py_TPFLAGS_HAVE_NEWBUFFER|Py_TPFLAGS_BASETYPE|Py_TPFLAGS_HAVE_GC, /*tp_flags*/
  0, /*tp_doc*/
  __pyx_tp_traverse_18Rejection_free_kmc_common_functions, /*tp_traverse*/
  __pyx_tp_clear_18Rejection_free_kmc_common_functions, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_18Rejection_free_kmc_common_functions, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_18Rejection_free_kmc_common_functions, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static struct __pyx_vtabstruct_18Rejection_free_kmc_rejection_free __pyx_vtable_18Rejection_free_kmc_rejection_free;

static PyObject *__pyx_tp_new_18Rejection_free_kmc_rejection_free(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_18Rejection_free_kmc_rejection_free *p;
  PyObject *o = __pyx_tp_new_18Rejection_free_kmc_common_functions(t, a, k);
  if (unlikely(!o)) return 0;
  p = ((struct __pyx_obj_18Rejection_free_kmc_rejection_free *)o);
  p->__pyx_base.__pyx_vtab = (struct __pyx_vtabstruct_18Rejection_free_kmc_common_functions*)__pyx_vtabptr_18Rejection_free_kmc_rejection_free;
  if (unlikely(__pyx_pw_18Rejection_free_kmc_14rejection_free_1__cinit__(o, a, k) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
static PyMethodDef __pyx_methods_18Rejection_free_kmc_rejection_free[] = {
  {"loop", (PyCFunction)__pyx_pw_18Rejection_free_kmc_14rejection_free_3loop, METH_NOARGS, 0},
  {"end", (PyCFunction)__pyx_pw_18Rejection_free_kmc_14rejection_free_5end, METH_NOARGS, 0},
  {"start", (PyCFunction)__pyx_pw_18Rejection_free_kmc_14rejection_free_7start, METH_NOARGS, 0},
  {"start_from_middle", (PyCFunction)__pyx_pw_18Rejection_free_kmc_14rejection_free_9start_from_middle, METH_NOARGS, 0},
  {"__reduce_cython__", (PyCFunction)__pyx_pw_18Rejection_free_kmc_14rejection_free_11__reduce_cython__, METH_NOARGS, 0},
  {"__setstate_cython__", (PyCFunction)__pyx_pw_18Rejection_free_kmc_14rejection_free_13__setstate_cython__, METH_O, 0},
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_18Rejection_free_kmc_rejection_free = {
  PyVarObject_HEAD_INIT(0, 0)
  "Rejection_free_kmc.rejection_free", /*tp_name*/
  sizeof(struct __pyx_obj_18Rejection_free_kmc_rejection_free), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_18Rejection_free_kmc_common_functions, /*tp_dealloc*/
  #if PY_VERSION_HEX < 0x030800b4
  0, /*tp_print*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_18Rejection_free_kmc_rejection_free, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_18Rejection_free_kmc_rejection_free, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static int __pyx_pymod_exec_Rejection_free_kmc(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_Rejection_free_kmc},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_s_Calculation_start, __pyx_k_Calculation_start, sizeof(__pyx_k_Calculation_start), 0, 0, 1, 0},
  {&__pyx_kp_s_Finished, __pyx_k_Finished, sizeof(__pyx_k_Finished), 0, 0, 1, 0},
  {&__pyx_kp_s_Loop_start, __pyx_k_Loop_start, sizeof(__pyx_k_Loop_start), 0, 0, 1, 0},
  ...
  {&__pyx_kp_s_Time_event, __pyx_k_Time_event, sizeof(__pyx_k_Time_event), 0, 0, 1, 0},
  ...
  {&__pyx_kp_s_current_number_of_atoms, __pyx_k_current_number_of_atoms, sizeof(__pyx_k_current_number_of_atoms), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_rejection_free, __pyx_k_rejection_free, sizeof(__pyx_k_rejection_free), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_rf_class, __pyx_k_rf_class, sizeof(__pyx_k_rf_class), 0, 0, 1, 1},
  ...
  {&__pyx_kp_s_started_time, __pyx_k_started_time, sizeof(__pyx_k_started_time), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_total_atoms, __pyx_k_total_atoms, sizeof(__pyx_k_total_atoms), 0, 0, 1, 1},
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_18Rejection_free_kmc_Params) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  #if PY_VERSION_HEX < 0x030800B1
  __pyx_type_18Rejection_free_kmc_Params.tp_print = 0;
  #endif
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_type_18Rejection_free_kmc_Params.tp_dictoffset && __pyx_type_18Rejection_free_kmc_Params.tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_type_18Rejection_free_kmc_Params.tp_getattro = __Pyx_PyObject_GenericGetAttr;
  }
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_Params, (PyObject *)&__pyx_type_18Rejection_free_kmc_Params) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_18Rejection_free_kmc_Params) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_ptype_18Rejection_free_kmc_Params = &__pyx_type_18Rejection_free_kmc_Params;
  __pyx_vtabptr_18Rejection_free_kmc_common_functions = &__pyx_vtable_18Rejection_free_kmc_common_functions;
  __pyx_vtable_18Rejection_free_kmc_common_functions.start_setting = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_start_setting;
  __pyx_vtable_18Rejection_free_kmc_common_functions.update_progress = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_update_progress;
  __pyx_vtable_18Rejection_free_kmc_common_functions.start_rejection_free = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_start_rejection_free;
  __pyx_vtable_18Rejection_free_kmc_common_functions.energy_summarize = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_energy_summarize;
  __pyx_vtable_18Rejection_free_kmc_common_functions.height_check_add = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, PyObject *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_height_check_add;
  __pyx_vtable_18Rejection_free_kmc_common_functions.height_check_remove = (int (*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, PyObject *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_height_check_remove;
  __pyx_vtable_18Rejection_free_kmc_common_functions.deposition = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_deposition;
  __pyx_vtable_18Rejection_free_kmc_common_functions.update_after_deposition = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, PyObject *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_update_after_deposition;
  __pyx_vtable_18Rejection_free_kmc_common_functions.update_events = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_update_events;
  __pyx_vtable_18Rejection_free_kmc_common_functions.recalculate_total_rate = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_recalculate_total_rate;
  __pyx_vtable_18Rejection_free_kmc_common_functions.compare_rate = (double (*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_compare_rate;
  __pyx_vtable_18Rejection_free_kmc_common_functions.rejection_free_deposition = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_rejection_free_deposition;
  __pyx_vtable_18Rejection_free_kmc_common_functions.put_first_atoms_rf = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_put_first_atoms_rf;
  __pyx_vtable_18Rejection_free_kmc_common_functions.rejection_free_event = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_rejection_free_event;
  __pyx_vtable_18Rejection_free_kmc_common_functions.event_progress = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_event_progress;
  __pyx_vtable_18Rejection_free_kmc_common_functions.pickle_dump = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, PyObject *, PyObject *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_pickle_dump;
  __pyx_vtable_18Rejection_free_kmc_common_functions.parameter_record = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_common_functions *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_16common_functions_parameter_record;
  ...
  __pyx_vtable_18Rejection_free_kmc_rejection_free.loop = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_rejection_free *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_14rejection_free_loop;
  __pyx_vtable_18Rejection_free_kmc_rejection_free.end = (PyObject *(*)(struct __pyx_obj_18Rejection_free_kmc_rejection_free *, int __pyx_skip_dispatch))__pyx_f_18Rejection_free_kmc_14rejection_free_end;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initRejection_free_kmc(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initRejection_free_kmc(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_Rejection_free_kmc(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_Rejection_free_kmc(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_Rejection_free_kmc(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'Rejection_free_kmc' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_Rejection_free_kmc(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("Rejection_free_kmc", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_Rejection_free_kmc) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Rejection_free_kmc")) {
      if (unlikely(PyDict_SetItemString(modules, "Rejection_free_kmc", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_Modules_lattice_form, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_lattice_form); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_lattice_form, __pyx_t_1) < 0) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "Rejection_free_kmc.pyx":6
 * import time
 * from Modules.lattice_form import lattice_form
 * from Modules.deposition import deposit_an_atom             # <<<<<<<<<<<<<<
 * from Modules.atoms_recalculate import recalculate
 ...
 */
  ...
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_Modules_deposition, __pyx_t_2, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_ImportFrom(__pyx_t_1, __pyx_n_s_deposit_an_atom); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_deposit_an_atom, __pyx_t_2) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "Rejection_free_kmc.pyx":7
 * from Modules.lattice_form import lattice_form
 * from Modules.deposition import deposit_an_atom
 * from Modules.atoms_recalculate import recalculate             # <<<<<<<<<<<<<<
 * from Modules.rejection_free_choose import rejection_free_choise
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_Modules_atoms_recalculate, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_recalculate); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_recalculate, __pyx_t_1) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "Rejection_free_kmc.pyx":8
 * from Modules.deposition import deposit_an_atom
 * from Modules.atoms_recalculate import recalculate
 * from Modules.rejection_free_choose import rejection_free_choise             # <<<<<<<<<<<<<<
 * from Modules.event_collection import site_events
 ...
 */
  ...
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_Modules_rejection_free_choose, __pyx_t_2, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_ImportFrom(__pyx_t_1, __pyx_n_s_rejection_free_choise); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_rejection_free_choise, __pyx_t_2) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "Rejection_free_kmc.pyx":9
 * from Modules.atoms_recalculate import recalculate
 * from Modules.rejection_free_choose import rejection_free_choise
 * from Modules.event_collection import site_events             # <<<<<<<<<<<<<<
 * import math
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_Modules_event_collection, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_site_events); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_site_events, __pyx_t_1) < 0) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "Rejection_free_kmc.pyx":10
 * from Modules.rejection_free_choose import rejection_free_choise
 * from Modules.event_collection import site_events
 * import math             # <<<<<<<<<<<<<<
 * import copy
 ...
 */
  ...
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_Modules_recording, __pyx_t_2, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_ImportFrom(__pyx_t_1, __pyx_n_s_record_data); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_record_data, __pyx_t_2) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "Rejection_free_kmc.pyx":13
 * import copy
 * from Modules.recording import record_data
 * from Modules.recording import rec_events_per_dep             # <<<<<<<<<<<<<<
 * import os
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_Modules_recording, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_rec_events_per_dep); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_rec_events_per_dep, __pyx_t_1) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "Rejection_free_kmc.pyx":14
 * from Modules.recording import record_data
 * from Modules.recording import rec_events_per_dep
 * import os             # <<<<<<<<<<<<<<
 * import pickle
 ...
 * 
 */
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_yaml, 0, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_yaml, __pyx_t_2) < 0) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "Rejection_free_kmc.pyx":19
 * # import decimal
 * import yaml
 * from pathlib import Path             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Rejection_free_kmc", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init Rejection_free_kmc");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
